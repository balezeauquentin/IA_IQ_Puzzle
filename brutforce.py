...
def brutforce2(affichage : interface.Interface, pieces, used_pieces, position=(0, 0)):
        ...
        if used_pieces[piece_id - 1] == 0:
            ...
            for _ in range(4):
                ...
                if jeu.peut_placer_piece(table, current_piece.piece, (i, j)):
                    ...
                    brutforce2(affichage, pieces, updated_used_pieces, next_position)
                current_piece.tourner_piece_horraire()  # Renomme la fonction pour éviter le conflit de noms

if __name__ == "__main__":
    a = interface.Interface()
    brutforce2(a, None, [0 for _ in range(12)])
